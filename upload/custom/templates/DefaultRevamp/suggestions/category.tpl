	  ...
	  <div class="ui centered row">
		<div class="ui ten wide tablet twelve wide computer column">
		  ...
		  <div class="ui small dropdown primary button">
		    ...
		    <div class="menu">
			  <a rel="noopener nofollow" class="item" href="/suggestions/category/{$CATEGORY_ID}/?sort=newest">{$NEWEST}</a>
			  <a rel="noopener nofollow" class="item" href="/suggestions/category/{$CATEGORY_ID}/?sort=recent-activity">{$RECENT_ACTIVITY}</a>
			  <a rel="noopener nofollow" class="item" href="/suggestions/category/{$CATEGORY_ID}/?sort=likes">{$LIKES}</a>
		    </div>
		  </div>
